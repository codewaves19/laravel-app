...
<form method="POST" action="/jobs/{{ $job->id }}">
    @csrf
    @method('PATCH') // we have made a post request as browser dont understand patch but used method patch which is known to laravel, this directive expands to a hidden input and laravel will read that input automatically and will hit patch route automatically
